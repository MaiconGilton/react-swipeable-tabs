...
|------|------|---------|-------------|
| `className` | `string` | - | Optional CSS class name. |
| `showIndicator` | `boolean` | `true` | Whether to show the built-in animated indicator. |
| `indicatorClassName` | `string` | - | Optional CSS class name for the built-in indicator. |
